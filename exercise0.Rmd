...
B and A are both symmetric square matrices and their formulas are the same giving $B = \sum_{j=1}^n \lambda_jx_jx_j^T = A$. Hence their eigenvalues and eigenvectors are the same.
...
### Task a
Expectation E has to be linear since probabilities are increasingly linear until reaching $P(\omega) = 1$.
